                    ...
                    <div class="card-body px-5">
                        <form action="{{ url('uploadproduct') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="mb-4">
                                ...
                                <x-jet-input type="text" name="name" placeholder="Nama File" />
                            </div>

                            <div class="mb-4">
                                <x-jet-label value="{{ __('Deskripsi') }}" />
                                <x-jet-input type="textarea" name="description" placeholder="Deskripsi File"
                                    style="height: 100px" />
                            </div>
                            ...
                            <div class="mb-5">
                                ...
                                <x-jet-input type="file" name="file" />
                            </div>

                            <x-jet-input type="submit" value="Submit" class="btn btn-dark" />
                        </form>
                    </div>
                </div>
                <div class="col-4"></div>
