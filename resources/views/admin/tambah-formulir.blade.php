<x-app-layout>
    ...
    <div class="container mt-5 py-5 px-5">
        <div class="card p-5 shadow-sm">
            <form action="{{ route('tambahformuliradmin') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <h2 class="text-center fw-bold">Data Mahasiswa</h2>
                <h5 class="text-center text-muted mb-5">Pendidikan Teknik Informatika dan Komputer</h5>
                <div class="mb-4">
                    <label for="exampleInputEmail1" class="form-label"><b>Nama</b></label>
                    <input type="text" class="form-control" id="nama" name="nama">
                </div>
                <div class="mb-4">
                    <label for="exampleInputPassword1" class="form-label"><b>NPM</b></label>
                    <input type="etxt" class="form-control" id="npm" name="npm">
                </div>
                <button type="submit" class="btn btn-primary text-light"><b>Simpan</b></button>
            </form>
        </div>
    </div>
</x-app-layout>
