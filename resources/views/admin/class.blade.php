    ...
    <main>
        <div class="row mt-5 pt-5 px-5">
            <div class="col-12 mt-3">
                <div class="card p-5">
                    <h2 class="text-center fw-bold">Kelas Algoritma Pemrograman</h2>
                    <h5 class="text-center text-muted mb-5">Rekam Medis</h5>
                    <div class="row">
                        <div class="col-12 py-3">
                            <a href="#" style="text-decoration: none; color:black">
                                <h5 class="fw-bold">
                                    Pertemuan 1 - Apa itu internet
                                </h5>
                                <h6 class="text-muted">Lorem ipsum dolor sit amet consectetur adipisicing elit.
                                    Voluptates eius vel sapiente earum voluptatum pariatur iure suscipit doloremque sint
                                    numquam?</h6>
                            </a>
                        </div>
                        <div class="col-12 py-3 mb-3">
                            <a href="#" style="text-decoration: none; color:black">
                                <h5 class="fw-bold">
                                    Pertemuan 2 - Apa itu website
                                </h5>
                                <h6 class="text-muted">Lorem ipsum dolor sit amet consectetur adipisicing elit.
                                    Voluptates eius vel sapiente earum voluptatum pariatur iure suscipit
                                    doloremque sint numquam?</h6>
                            </a>
                        </div>
                    </div>
                </div>
