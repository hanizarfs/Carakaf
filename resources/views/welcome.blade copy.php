...
<body>
    ...
    <div class="container">
        <img src="https://images.unsplash.com/photo-1584697964156-deca98e4439d?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1171&q=80" alt="">
        <a href="{{ url('/uploadpage') }}" class="btn btn-success">Upload Pages</a>
